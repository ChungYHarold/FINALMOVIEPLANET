...
<link rel="stylesheet" type="text/css" href="http://movie1.sist.co.kr/css/PcCommonCssBundle_merged.css" />
				...
				success: function(jsonObj){
			        ...
			        $.each(jsonObj.director, function(idx, ele) {
			            ...
			            if (count % 7 === 0) {
			      	   ...
			      	   // 감독<td> 하나씩 화면에 출력 
			            output += "<td>" +
			                "<img class='thumbnail' src='http://movie1.sist.co.kr/images/" + ele.d_img + "'><br>" +
			        ...
			        $.each(jsonObj.actor, function(idx, ele) {
			        	...
			        	//배우<td> 하나씩 화면에 출력
			            output += "<td>" +
			                "<img class='thumbnail' src='http://movie1.sist.co.kr/images/" + ele.a_img + "'><br>" +
    ...
    <div class="kakaohead_top">
        <div class="inner_head" data-tiara-layer="service">
                ...
                <c:when test="${ empty lrDomain.user_id }">
	                ...
	                <img src="http://movie1.sist.co.kr/images/movie_small.png" width="70" height="35" class="logo_daum" alt="Daum"></a>
                </c:when>
                <c:when test="${ !empty lrDomain.user_id }">
