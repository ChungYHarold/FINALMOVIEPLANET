...
<link rel="stylesheet" type="text/css" href="http://movie1.sist.co.kr/css/login-sv-202203141106.css">
<link rel="stylesheet" type="text/css" href="http://movie1.sist.co.kr/css/footer-sv-202301261521.css"/> <!-- (JK-9495) PC Main Footer 변경 (2021.02.18) -->
...
<div id="wrap">
	<div id="container">
		<div class="logtop logtop_login" style="margin-bottom: 30px;">
			<img src="http://movie1.sist.co.kr/images/movie.png"/>
		...
		<div class="secLogin">
			...
			<div style="float:right">
				<h2 class="skip">광고</h2>
				<img src="http://movie1.sist.co.kr/images/ad_poster.png" style="width:300px; height:320px"/>
			</div><!-- AD //-->
