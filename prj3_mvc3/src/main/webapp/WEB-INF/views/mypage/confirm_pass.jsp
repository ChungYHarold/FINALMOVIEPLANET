...
<%@include file="../checkLogin.jsp" %>
	...
	<link rel="stylesheet" media="all" type="text/css" href="http://movie1.sist.co.kr/css/reset.css" />
    <link rel="stylesheet" media="all" type="text/css" href="http://movie1.sist.co.kr/css/layout.css" />
    <link rel="stylesheet" media="all" type="text/css" href="http://movie1.sist.co.kr/css/module.css" />
    <link rel="stylesheet" media="all" type="text/css" href="http://movie1.sist.co.kr/css/content.css" />
    <link rel="stylesheet" media="all" type="text/css" href="http://movie1.sist.co.kr/css/common.css" />
    ...
    <!-- devplanet css -->
    <link rel="stylesheet" type="text/css" href="http://movie1.sist.co.kr/css/mbr_style.css"/>
	<link rel="stylesheet" type="text/css" href="http://movie1.sist.co.kr/css/footer-sv-202301261521.css"/>
	<link rel="stylesheet" type="text/css" href="http://movie1.sist.co.kr/css/mbr_tpl.css"/>
    		...
    		<div class="contents">
        		<h1 onclick="">
       			<a href="main_loged_frm.do">
        			<img src="http://movie1.sist.co.kr/images/movie.png" alt="movieplanet" />
        		</a>
        ...
        <div class="sect-person-info">
        	...
        	<div class="box-image">
				<span class="thumb-image">
					<img src="http://movie1.sist.co.kr/images/${lrDomain.profile eq null ? 'default_profile.gif' : lrDomain.profile }" alt="${ lrDomain.name }님 프로필 사진" onerror="errorImage(this, {'type':'profile'})" />
