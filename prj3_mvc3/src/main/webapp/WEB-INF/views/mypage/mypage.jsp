        ...
        <div class="sect-person-info">
        	...
        	<div class="box-image">
				<span class="thumb-image">
					<img src="http://movie1.sist.co.kr/upload/${lrDomain.profile eq null ? 'default_profile.gif' : lrDomain.profile }" alt="${ lrDomain.name }님 프로필 사진" onerror="errorImage(this, {'type':'profile'})" />
