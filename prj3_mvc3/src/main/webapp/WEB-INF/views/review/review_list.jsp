...
<body class=""> 
    ...
    <div class="kakaohead_top">
        <div class="inner_head" data-tiara-layer="service">
                <a class="link_daum" data-tiara-layer="logo"><img src="http://movie1.sist.co.kr/images/movie_small.png" width="70" height="35" class="logo_daum" alt="Daum"></a>
...
<article id="mainContent" class="kakao_article">
    ...
    <img src="http://movie1.sist.co.kr/images/KakaoTalk_20230504_212827923_01.jpg"  style="border-radius: 15px" />
    </div>
...
<div class="tabmenu_wrap">
    ...
    <ul class="list_tabmenu" role="tablist" data-tiara-layer="tab">
        <li  role="presentation"><!-- 선택시 on 클래스 추가 -->
            <a href="http://movie1.sist.co.kr/mainInfo.jsp" class="link_tabmenu" aria-selected="false" role="tab" data-tiara-layer="menu" data-tiara-copy="탭_주요정보">
                <span class="txt_tabmenu">주요정보</span>
            </a>
        </li>
        <li  role="presentation">
            <a href="http://movie1.sist.co.kr/crew.jsp" class="link_tabmenu" aria-selected="false" role="tab"  data-tiara-layer="crew" data-tiara-copy="탭_출연/제작">
                <span class="txt_tabmenu">출연/제작</span>
            </a>
        </li>
        <li  role="presentation">
            <a href="http://movie1.sist.co.kr/grade.jsp" class="link_tabmenu" aria-selected="false" role="tab"  data-tiara-layer="media" data-tiara-copy="탭_영상/포토">
                <span class="txt_tabmenu">평점</span>
            </a>
        </li>
        <li  role="presentation">
            <a href="http://movie1.sist.co.kr/review.jsp" class="link_tabmenu" aria-selected="false" role="tab" data-tiara-layer="grade" data-tiara-copy="탭_평점">
