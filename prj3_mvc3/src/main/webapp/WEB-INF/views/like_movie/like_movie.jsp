				...
				<div class="contents">
					<h1 onclick="">
						<a href="main_loged_frm.do"> <img
							src="http://movie1.sist.co.kr/images/movie.png"
							alt="movieplanet" />
            ...
            <div class="inner-contents-profile">
                <div class="box-image">
                	<div class="thumb-image">
                        <img src="http://movie1.sist.co.kr/images/default_profile.gif" alt="모민경님 프로필 사진" onerror="errorImage(this, {type:'profile'})" />
